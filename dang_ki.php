                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <form class="login_form row" method="post" action="./admin/dang_nhap_thuc_hien.php" onsubmit="return validateForm()">
                                ...
                                <div class="col-lg-12 form-group">
                                <div id="dangnhap">
                                    <button type="submit" value="submit" class="btn subs_btn form-control" style=" margin-left: 5% ;text-align: center; margin-top: 15px; color: #000; font-weight: bolder;">Đăng nhập</button>
                                </div>
                                  </div>
                            </form>
                        </div>
                        <div class="col-lg-8">
                            ...
                            <form name="txtDangKi" class="login_form row" method="post" action="dang_ki_thuc_hien.php" onsubmit="return validateForm()"> 
                                ...
                                <div class="col-lg-6 form-group" id="gioitinh">
                                ...
                                <div class="col-lg-12 form-group">
                                    <button type="submit" value="submit" class="btn subs_btn form-control "  style="text-align: center; margin-left: 25%; color: #000; font-weight: bolder;">Đăng kí ngay</button>
                                </div>
                            </form>
                        </div>
                    </div>
