                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="login_title">
                                ...
                                <p>Đăng nhập để khám phá những tính năng của trang web</p>
                            </div>
                            <form class="login_form row"method="post" action="./admin/dang_nhap_thuc_hien.php" onsubmit="return validateForm()">
                                ...
                                <div class="col-lg-12 form-group">
                                    <div class="creat_account">
                                        ...
                                        <label for="f-option">Lưu mật khẩu đăng nhập</label>
                                        <div class="check"></div>
                                    </div>
                                    <h4>Bạn chưa có tài khoản? <a href="dang_ki.php"></a></h4>
                                </div>
                                <div class="col-lg-12 form-group">
                                    <button type="submit" value="submit" class="btn update_btn form-control">Đăng nhập</button>
                                </div>
                            </form>
                        </div>
