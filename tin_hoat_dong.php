...
<html lang="en">
	<head>
		...
		<title>Công Ty Di Động Việt || Tin hoạt động</title>
		<!-- Icon -->
				...
				<!-- row -->
					<div class="row">
						<div class="col-md-8" id="tintuctrai">
							<h3 class="title">TIN HOẠT ĐỘNG</h3>
							<hr>
							<table>
								<?php
						...
						<table>
								...
								<tr>
									...
									<td valign="top" >
										...
										<h3 class="product-name"><a href="tin_tuc_chi_tiet.php?id=<?php echo $row["id"];?>"><?php echo $row["ten_san_pham"];?></a></h3>
